	...
	do a = Nel+1,No
		...
		do b = Nel+1,No
		do c = Nel+1,No
			sum=sum+R(j,b,k,c)*t3(i,j,k,a,b,c)
		enddo
		enddo
		enddo
		enddo
	...
	return
	end subroutine projection_ccsdt_singles_spin_hf