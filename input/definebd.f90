    ...
    void=bdCollect('scf',addr(1:6),bdstart,bdstop,bdcomment,bdaccord,bdseparator,false,0)
    ...
    void=bdCollect('linear-response',addr(1:10),bdstart,bdstop,bdcomment,bdaccord,bdseparator,false,0)
