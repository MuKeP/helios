    subroutine projection_ccs_singles_spatial_cue
    ...
    do u = 1,Ne
        ...
        do b = Nocc+1,N
            k=i; j=iapairs(b)
            sum=sum+R(k,b,j,i)*t1(j,a)*t1(k,b)
        ...
        do k = 1,Nocc
            do j = 1,Nocc
                ...
                do t = 1,2
                    ...
                    sum=sum-R(k,c,j,b)*t1(k,a)*t1(j,b)*t1(i,c)
                    if (k.EQ.j) exit
                enddo
            enddo
        enddo
    ...
    return
    end subroutine projection_ccs_singles_spatial_cue