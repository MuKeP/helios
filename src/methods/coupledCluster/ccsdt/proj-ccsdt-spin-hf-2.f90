    ...
    do b = a+1,No
        ...
        do l = 1,Nel
        do c = Nel+1,No
            sum=sum+R(k,i,l,c)*(t3(j,k,l,a,b,c)/2+t1(l,c)*t2(j,k,a,b))&
                   -R(k,j,l,c)*(t3(i,k,l,a,b,c)/2+t1(l,c)*t2(i,k,a,b))
    ...
    return
    end subroutine projection_ccsdt_doubles_spin_hf