...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ MODULES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	use glob      , only: rglu,iglu,lglu,i4kind,void
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ VARIABLES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	integer(kind=iglu)   :: su,init,in,ou,eu,unul,lrg
	! Memory: 6*iglu
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	!MS$if(OS.EQ.2)
		fid=fcNewID()
		open  (fid,file=uchGet(pauseFileName))   ; write (fid,"('kill -19 ',i5)") appPID; close (fid)
		open  (fid,file=uchGet(continueFileName)); write (fid,"('kill -18 ',i5)") appPID; close (fid)
		void=fcNullID(fid)
		err=system('chmod +x '//uchGet(pauseFileName)); err=system('chmod +x '//uchGet(continueFileName))
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	!MS$if(OS.EQ.2)
		fid=fcNewID()
		open (fid,file=uchGet(pauseFileName))   ; close (fid,status='delete')
		open (fid,file=uchGet(continueFileName)); close (fid,status='delete')
		void=fcNullID(fid)
	!MS$endif
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	!MS$if(OS.EQ.2)
		...
		select case (SIGNUM)
			...
			case (SIGUSR1); write (ou,101) SIGUSR1; rcode=1; return
		end select
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
	...
	!define names.
	pauseFileName   =uchSet('pauseproc.sh')
	continueFileName=uchSet('continueproc.sh')
