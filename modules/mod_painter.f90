...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
    ...
    enddo
    sumCoordinates=sumCoordinates/N
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
    ...
    angtorot=dtr*360._rglu/polygon_n
    polygon_rad=ccbond/sin(angtorot)*sin(dtr*(180._rglu-360._rglu/polygon_n)/2) ! sin theorem
...
!   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   !
    ...
    cos_ang = chis/zna
    if (abs(cos_ang) .ge. 1._rglu) cos_ang = sign (1._rglu,cos_ang)
